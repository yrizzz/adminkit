        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-3 sm:px-6 gap-2">
            ...
            <a href="{{ route('landing') }}" wire:navigate class="flex items-center gap-2.5 sm:gap-3 group shrink-0">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-[10px] font-mono text-blue-400 font-semibold leading-tight mt-0.5">v1.2.0</span>
                </div>
            </a>

            {{-- Navigation Links (Desktop) --}}
            <nav class="hidden md:flex items-center gap-8 text-xs sm:text-sm font-medium text-slate-300">
                <a href="#features" class="hover:text-blue-400 transition-colors">Features</a>
                <a href="#showcase" class="hover:text-blue-400 transition-colors">Preview Demos</a>
                <a href="#tech" class="hover:text-blue-400 transition-colors">Tech Stack</a>
                <a href="#quickstart" class="hover:text-blue-400 transition-colors">Quickstart</a>
                <a href="#faq" class="hover:text-blue-400 transition-colors">FAQ</a>
                <a href="{{ route('page', ['path' => 'docs']) }}" wire:navigate class="hover:text-blue-400 transition-colors">Documentation</a>
            </nav>
            ...
            <div class="mx-auto max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center w-full">
                ...
                <div class="lg:col-span-6 space-y-5 sm:space-y-6 text-center lg:text-start">
                    ...
                    <div class="inline-flex items-center gap-2.5 flex-wrap justify-center lg:justify-start">
                        ...
                        <span class="rounded-full bg-slate-800/90 px-4 py-1.5 text-xs font-semibold text-slate-300 border border-slate-700/80 backdrop-blur">
                            100% Free Forever
                        </span>
                    </div>

                    {{-- Pro Headline --}}
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.12] text-white">
                        Admin Dashboard <br />
                        Modern, Clean, <br />
                        and <span class="bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-400 bg-clip-text text-transparent underline decoration-blue-500/40 underline-offset-8">Powerful Pro</span>
                    </h1>

                    {{-- Description --}}
                    <p class="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl mx-auto lg:mx-0 font-normal">
                        The ultimate enterprise admin panel boilerplate powered by <strong>Laravel 13, Livewire 4, and Tailwind CSS v4</strong>. Packed with 13 dashboard templates, 40+ Blade components, real-time theme customizer, and lightning-fast SPA performance.
                    </p>
                    ...
                    {{-- Social Proof & Stats --}}
                    <div class="pt-3 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 text-xs sm:text-sm text-slate-400">
                        <div class="flex items-center gap-3">
                            <div class="flex -space-x-2 rounded-full overflow-hidden p-0.5">
                                <span class="flex size-8 items-center justify-center rounded-full ring-2 ring-[#070B14] bg-blue-600 text-white text-[10px] font-black leading-none tracking-tight">YZ</span>
                                <span class="flex size-8 items-center justify-center rounded-full ring-2 ring-[#070B14] bg-blue-700 text-white text-[10px] font-black leading-none tracking-tight">AK</span>
                                <span class="flex size-8 items-center justify-center rounded-full ring-2 ring-[#070B14] bg-indigo-600 text-white text-[10px] font-black leading-none tracking-tight">LV</span>
                            </div>
                            <span class="font-medium text-slate-300">Trusted by developers worldwide.</span>
                        </div>
                        <span class="hidden sm:inline text-slate-700">&bull;</span>
                        <div class="flex items-center gap-1.5 font-mono text-blue-400 font-semibold">
...
<span class="text-purple-400">php artisan</span> dev</pre>
        ...
        <section id="features" class="py-14 lg:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-12 lg:space-y-16">
            <div class="text-center max-w-3xl mx-auto space-y-4">
                <div>
                    <span class="inline-block rounded-full bg-blue-600/20 px-4 py-1.5 text-xs font-extrabold text-blue-400 border border-blue-500/40 uppercase tracking-wider">KEY FEATURES</span>
                </div>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">Built for Developers</h2>
                <p class="text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">Everything you need to build fast, modern, and highly scalable admin dashboards.</p>
            </div>

            {{-- 6 Feature Cards Grid --}}
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {{-- 1. Modern & Clean UI --}}
                <div data-aos="fade-up" style="transition-delay: 0ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="palette" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">Modern & Clean UI</h3>
                ...
                {{-- 2. Fully Responsive --}}
                <div data-aos="fade-up" style="transition-delay: 100ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="layout" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">Fully Responsive</h3>
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                ...
                <div data-aos="fade-up" style="transition-delay: 200ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="cpu" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">Rich Component Library</h3>
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                ...
                <div data-aos="fade-up" style="transition-delay: 300ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="code" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">Developer Friendly</h3>
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                ...
                <div data-aos="fade-up" style="transition-delay: 400ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="zap" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">Multiple Color Options</h3>
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                        Built-in HSL color presets to match your enterprise brand identity and visual theme instantly.
                    </p>
                </div>

                {{-- 6. 100% Open Source --}}
                <div data-aos="fade-up" style="transition-delay: 500ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 hover:border-blue-500/50 hover:bg-slate-900/90 transition-all duration-300 group hover:-translate-y-1 shadow-lg backdrop-blur">
                    <div class="size-12 rounded-xl bg-blue-600/15 border border-blue-500/30 text-blue-400 grid place-items-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-md">
                        <x-ui.icon name="github" class="size-6" />
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-white">100% Open Source</h3>
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
        ...
        <section id="showcase" class="py-14 lg:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-12 lg:space-y-16">
            <div class="text-center max-w-3xl mx-auto space-y-4">
                <div>
                    <span class="inline-block rounded-full bg-blue-600/20 px-4 py-1.5 text-xs font-extrabold text-blue-400 border border-blue-500/40 uppercase tracking-wider">PREVIEW DEMOS</span>
                </div>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">Explore AdminKit Inside & Out</h2>
                <p class="text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">A glimpse of core view templates and UI components available in AdminKit.</p>
            </div>

            {{-- 4 Page Preview Cards --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {{-- Card 1: Dashboard --}}
                <div data-aos="fade-up" style="transition-delay: 0ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/70 overflow-hidden space-y-3 p-4 hover:border-blue-500/60 transition-all cursor-pointer group hover:-translate-y-1 shadow-md" @click="activeDemo = 'sales'">
                    <div class="rounded-xl border border-slate-800 bg-slate-950 p-3 h-36 flex flex-col justify-between group-hover:scale-[1.02] transition-transform">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="h-2 w-1/2 rounded bg-slate-800"></div>
                        </div>
                        <div class="h-10 w-full rounded bg-blue-600/20 border border-blue-500/30"></div>
                    </div>
                    <div>
                        <h4 class="text-base font-bold text-white group-hover:text-blue-400 transition-colors">Dashboard Overview</h4>
                        <p class="text-xs sm:text-sm text-slate-300 mt-1">Modern analytics dashboard with real-time widgets and interactive charts.</p>
                    </div>
                </div>

                {{-- Card 2: Tables --}}
                <div data-aos="fade-up" style="transition-delay: 100ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/70 overflow-hidden space-y-3 p-4 hover:border-blue-500/60 transition-all cursor-pointer group hover:-translate-y-1 shadow-md" @click="activeDemo = 'ecommerce'">
                    <div class="rounded-xl border border-slate-800 bg-slate-950 p-3 h-36 flex flex-col justify-between group-hover:scale-[1.02] transition-transform">
                        <div class="flex items-center justify-between text-[11px] font-bold text-blue-400">
                            <span>Tables</span>
                            <span class="size-2 rounded-full bg-blue-500"></span>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="h-2 w-full rounded bg-slate-800/60"></div>
                            <div class="h-2 w-full rounded bg-slate-800/40"></div>
                        </div>
                        <div class="h-4 w-1/3 rounded bg-blue-600/30"></div>
                    </div>
                    <div>
                        <h4 class="text-base font-bold text-white group-hover:text-blue-400 transition-colors">Data Tables</h4>
                        <p class="text-xs sm:text-sm text-slate-300 mt-1">Responsive data tables with instant sorting, searching, and pagination.</p>
                    </div>
                </div>

                {{-- Card 3: Forms --}}
                <div data-aos="fade-up" style="transition-delay: 200ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/70 overflow-hidden space-y-3 p-4 hover:border-blue-500/60 transition-all cursor-pointer group hover:-translate-y-1 shadow-md" @click="activeDemo = 'crm'">
                    <div class="rounded-xl border border-slate-800 bg-slate-950 p-3 h-36 flex flex-col justify-between group-hover:scale-[1.02] transition-transform">
                        <div class="flex items-center justify-between text-[11px] font-bold text-blue-400">
                            <span>Forms</span>
                            <span class="size-2 rounded-full bg-blue-500"></span>
                        ...
                        <div class="space-y-2">
                            <div class="h-5 w-full rounded border border-slate-800 bg-slate-900"></div>
                            <div class="h-5 w-full rounded border border-slate-800 bg-slate-900"></div>
                        </div>
                        <div class="h-6 w-full rounded bg-blue-600 text-white text-[10px] grid place-items-center font-bold">Submit</div>
                    </div>
                    <div>
                        <h4 class="text-base font-bold text-white group-hover:text-blue-400 transition-colors">Form Elements</h4>
                        <p class="text-xs sm:text-sm text-slate-300 mt-1">Complete collection of styled form controls ready for immediate integration.</p>
                    </div>
                </div>

                {{-- Card 4: Charts --}}
                <div data-aos="fade-up" style="transition-delay: 300ms;" class="rounded-2xl border border-slate-800/80 bg-slate-900/70 overflow-hidden space-y-3 p-4 hover:border-blue-500/60 transition-all cursor-pointer group hover:-translate-y-1 shadow-md" @click="activeDemo = 'sales'">
                    <div class="rounded-xl border border-slate-800 bg-slate-950 p-3 h-36 flex flex-col justify-between group-hover:scale-[1.02] transition-transform">
                        <div class="flex items-center justify-between text-[11px] font-bold text-blue-400">
                            <span>Charts</span>
                            <span class="size-2 rounded-full bg-blue-500"></span>
                    ...
                    <div>
                        <h4 class="text-base font-bold text-white group-hover:text-blue-400 transition-colors">Interactive Charts</h4>
                        <p class="text-xs sm:text-sm text-slate-300 mt-1">Seamless data visualization integrations using Chart.js & ApexCharts.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center pt-2">
                <a href="{{ route('page', ['path' => 'docs']) }}" wire:navigate
                   class="inline-flex items-center gap-2 rounded-xl border border-blue-500/40 bg-blue-600/10 px-6 py-3.5 text-xs sm:text-sm font-bold text-blue-400 hover:bg-blue-600 hover:text-white transition-all shadow-md">
        ...
        <section id="tech" class="py-14 lg:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-10 lg:space-y-14 border-t border-b border-slate-800/80 bg-slate-900/30 backdrop-blur">
            <div class="text-center max-w-3xl mx-auto space-y-4">
                <div>
                    <span class="inline-block rounded-full bg-blue-600/20 px-4 py-1.5 text-xs font-extrabold text-blue-400 border border-blue-500/40 uppercase tracking-wider">TECHNOLOGY STACK</span>
                </div>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">Built with Modern Technologies</h2>
                <p class="text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">Powered by industry-standard tools trusted by millions of developers worldwide.</p>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-4 max-w-5xl mx-auto">
                {{-- 1. Laravel 13 --}}
                <div class="group relative rounded-2xl border border-red-500/20 bg-gradient-to-b from-red-500/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-red-500/60 hover:shadow-lg hover:shadow-red-500/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-red-500/15 border border-red-500/30 grid place-items-center text-red-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="cpu" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Laravel 13</span>
                            <span class="text-[9px] font-mono font-bold text-red-400 bg-red-500/10 px-1.5 py-0.5 rounded border border-red-500/20 shrink-0">v13</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">PHP Framework</p>
                    </div>
                </div>

                {{-- 2. Livewire 4 --}}
                <div class="group relative rounded-2xl border border-pink-500/20 bg-gradient-to-b from-pink-500/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-pink-500/60 hover:shadow-lg hover:shadow-pink-500/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-pink-500/15 border border-pink-500/30 grid place-items-center text-pink-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="zap" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Livewire 4</span>
                            <span class="text-[9px] font-mono font-bold text-pink-400 bg-pink-500/10 px-1.5 py-0.5 rounded border border-pink-500/20 shrink-0">v4</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Full-Stack SPA</p>
                    </div>
                </div>

                {{-- 3. Tailwind CSS v4 --}}
                <div class="group relative rounded-2xl border border-sky-400/20 bg-gradient-to-b from-sky-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-sky-400/60 hover:shadow-lg hover:shadow-sky-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-sky-500/15 border border-sky-400/30 grid place-items-center text-sky-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="palette" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Tailwind v4</span>
                            <span class="text-[9px] font-mono font-bold text-sky-400 bg-sky-400/10 px-1.5 py-0.5 rounded border border-sky-400/20 shrink-0">v4.0</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">CSS Engine</p>
                    </div>
                </div>

                {{-- 4. Chart.js --}}
                <div class="group relative rounded-2xl border border-amber-400/20 bg-gradient-to-b from-amber-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-amber-400/60 hover:shadow-lg hover:shadow-amber-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-amber-500/15 border border-amber-400/30 grid place-items-center text-amber-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="bar-chart-2" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Chart.js</span>
                            <span class="text-[9px] font-mono font-bold text-amber-400 bg-amber-400/10 px-1.5 py-0.5 rounded border border-amber-400/20 shrink-0">v4.4</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Interactive Charts</p>
                    </div>
                </div>

                {{-- 5. Alpine.js --}}
                <div class="group relative rounded-2xl border border-teal-400/20 bg-gradient-to-b from-teal-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-teal-400/60 hover:shadow-lg hover:shadow-teal-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-teal-500/15 border border-teal-400/30 grid place-items-center text-teal-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="code" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Alpine.js</span>
                            <span class="text-[9px] font-mono font-bold text-teal-400 bg-teal-400/10 px-1.5 py-0.5 rounded border border-teal-400/20 shrink-0">v3</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Micro JS Library</p>
                    </div>
                </div>

                {{-- 6. PHP 8.4 --}}
                <div class="group relative rounded-2xl border border-indigo-400/20 bg-gradient-to-b from-indigo-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-indigo-400/60 hover:shadow-lg hover:shadow-indigo-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-indigo-500/15 border border-indigo-400/30 grid place-items-center text-indigo-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="terminal" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">PHP 8.4</span>
                            <span class="text-[9px] font-mono font-bold text-indigo-400 bg-indigo-400/10 px-1.5 py-0.5 rounded border border-indigo-400/20 shrink-0">v8.4</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Server Runtime</p>
                    </div>
                </div>

                {{-- 7. Blade Icons --}}
                <div class="group relative rounded-2xl border border-blue-400/20 bg-gradient-to-b from-blue-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-blue-400/60 hover:shadow-lg hover:shadow-blue-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-blue-500/15 border border-blue-400/30 grid place-items-center text-blue-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="layers" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Blade Icons</span>
                            <span class="text-[9px] font-mono font-bold text-blue-400 bg-blue-400/10 px-1.5 py-0.5 rounded border border-blue-400/20 shrink-0">40+</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Lucide Icons</p>
                    </div>
                </div>

                {{-- 8. Vite Engine --}}
                <div class="group relative rounded-2xl border border-purple-400/20 bg-gradient-to-b from-purple-400/10 via-slate-900/80 to-slate-900/90 p-3 sm:p-4 hover:border-purple-400/60 hover:shadow-lg hover:shadow-purple-400/10 transition-all duration-300 backdrop-blur flex items-center gap-3">
                    <div class="size-9 sm:size-11 rounded-xl bg-purple-500/15 border border-purple-400/30 grid place-items-center text-purple-400 shrink-0 group-hover:scale-105 transition-transform">
                        <x-ui.icon name="sparkles" class="size-4 sm:size-5" />
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-1">
                            <span class="text-xs sm:text-sm font-extrabold text-white truncate">Vite Engine</span>
                            <span class="text-[9px] font-mono font-bold text-purple-400 bg-purple-400/10 px-1.5 py-0.5 rounded border border-purple-400/20 shrink-0">v6</span>
                        </div>
                        <p class="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Hot Module Reload</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="quickstart" class="py-14 lg:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-12 lg:space-y-16">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                ...
                {{-- Left: Use cases --}}
                <div class="lg:col-span-4 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 sm:p-8 space-y-6 flex flex-col justify-between shadow-xl backdrop-blur">
                    <div class="space-y-4">
                        <div>
                            <span class="inline-block rounded-full bg-blue-600/20 px-3.5 py-1 text-xs font-extrabold text-blue-400 border border-blue-500/40 uppercase tracking-wider">VERSATILE USE CASES</span>
                        </div>
                        <h3 class="text-xl sm:text-2xl lg:text-3xl font-black text-white">One Template, Endless Possibilities</h3>
                        <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                            AdminKit features a modular design architecture engineered to streamline any enterprise management platform.
                        </p>

                        <div class="space-y-3 pt-2 text-xs sm:text-sm font-medium text-slate-200">
                            <div class="flex items-center gap-2.5">
                                <x-ui.icon name="check-circle" class="size-4.5 text-blue-400 shrink-0" />
                ...
                <div class="lg:col-span-5 rounded-2xl border border-slate-800/80 bg-slate-900/90 p-4 sm:p-8 space-y-4 shadow-xl flex flex-col justify-between backdrop-blur overflow-hidden">
                    <div class="space-y-4">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-800 pb-3 gap-2">
                            <div class="flex items-center gap-2">
                                <span class="rounded-full bg-blue-600/20 px-3 py-0.5 text-[11px] font-bold text-blue-400 border border-blue-500/30">FAST INSTALLATION</span>
                            </div>

                            {{-- Tab Switches --}}
                            <div class="flex items-center gap-1 bg-slate-950 p-1 rounded-lg border border-slate-800 text-[11px]">
                                <button type="button" @click="activeTab = 'composer'" :class="activeTab === 'composer' ? 'bg-blue-600 text-white font-bold' : 'text-slate-400'" class="px-2.5 py-0.5 rounded">Composer</button>
                                <button type="button" @click="activeTab = 'git'" :class="activeTab === 'git' ? 'bg-blue-600 text-white font-bold' : 'text-slate-400'" class="px-2.5 py-0.5 rounded">Git Clone</button>
                            </div>
                        </div>

                        {{-- Code Window Composer --}}
                        <div x-show="activeTab === 'composer'" class="rounded-xl border border-slate-800 bg-[#050912] p-3.5 sm:p-4 font-mono text-xs text-slate-200 space-y-3 relative group overflow-hidden">
                            <div class="flex items-center justify-between border-b border-slate-800/60 pb-2">
                                ...
                                <button type="button" @click="copyCommand('composer create-project yrizzz/adminkit my-app')" class="px-2 py-1 rounded bg-slate-800 hover:bg-blue-600 text-slate-300 hover:text-white transition-all text-[10px] flex items-center gap-1 shrink-0">
                                    <x-ui.icon name="copy" class="size-3" />
                                    <span x-text="copied ? 'Copied!' : 'Copy'">Copy</span>
                                </button>
                            </div>

                            <div class="text-blue-400 font-bold overflow-x-auto break-all sm:break-normal text-[11px] sm:text-xs leading-relaxed py-1">$ composer create-project yrizzz/adminkit my-app</div>
                            
                            <div class="text-slate-500 text-[10px] pt-1"># Step 2: Boot local dev server</div>
                            <div class="text-blue-400 font-bold overflow-x-auto break-all sm:break-normal text-[11px] sm:text-xs leading-relaxed">$ cd my-app && php artisan dev</div>
                        </div>

                        {{-- Code Window Git --}}
                        <div x-show="activeTab === 'git'" x-cloak class="rounded-xl border border-slate-800 bg-[#050912] p-3.5 sm:p-4 font-mono text-xs text-slate-200 space-y-3 relative group overflow-hidden">
                            <div class="flex items-center justify-between border-b border-slate-800/60 pb-2">
                                <span class="text-slate-500 text-[10px]"># Step 1: Clone repository</span>
                                <button type="button" @click="copyCommand('git clone https://github.com/yrizzz/adminkit.git')" class="px-2 py-1 rounded bg-slate-800 hover:bg-blue-600 text-slate-300 hover:text-white transition-all text-[10px] flex items-center gap-1 shrink-0">
                                    <x-ui.icon name="copy" class="size-3" />
                                    <span x-text="copied ? 'Copied!' : 'Copy'">Copy</span>
                                </button>
                            </div>

                            <div class="text-blue-400 font-bold overflow-x-auto break-all sm:break-normal text-[11px] sm:text-xs leading-relaxed py-1">$ git clone https://github.com/yrizzz/adminkit.git</div>
                            
                            <div class="text-slate-500 text-[10px] pt-1"># Step 2: Install dependencies</div>
                            <div class="text-blue-400 font-bold overflow-x-auto break-all sm:break-normal text-[11px] sm:text-xs leading-relaxed">$ composer install && npm install</div>
                        </div>
                    </div>
                </div>

                {{-- Right: Stats List --}}
                <div class="lg:col-span-3 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 space-y-4 flex flex-col justify-around text-center lg:text-start shadow-xl backdrop-blur">
                    <div class="space-y-1">
                        <div class="text-3xl font-black text-blue-400">3.2k+</div>
                        <div class="text-xs text-slate-400 font-semibold">GitHub Stars</div>
                    </div>

                    <div class="space-y-1 border-t border-slate-800/80 pt-3">
                        <div class="text-3xl font-black text-white">100+</div>
                        <div class="text-xs text-slate-400 font-semibold">UI Components</div>
                    </div>

                    <div class="space-y-1 border-t border-slate-800/80 pt-3">
                        <div class="text-3xl font-black text-white">50+</div>
                        <div class="text-xs text-slate-400 font-semibold">Pre-built Pages</div>
                    </div>

                    <div class="space-y-1 border-t border-slate-800/80 pt-3">
                        <div class="text-3xl font-black text-blue-400">100%</div>
                        <div class="text-xs text-slate-400 font-semibold">Responsive & Free MIT</div>
                    </div>
                </div>
        ...
        <section id="faq" class="py-14 lg:py-24 px-4 sm:px-6 max-w-4xl mx-auto space-y-10 lg:space-y-14">
            <div class="text-center space-y-4">
                <div>
                    <span class="inline-block rounded-full bg-blue-600/20 px-4 py-1.5 text-xs font-extrabold text-blue-400 border border-blue-500/40 uppercase tracking-wider">FAQ</span>
                </div>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">Frequently Asked Questions</h2>
                <p class="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">Everything you need to know about using and licensing AdminKit.</p>
            </div>

            <div class="space-y-3.5">
                {{-- FAQ Item 1 --}}
                <div class="rounded-2xl border border-slate-800 bg-slate-900/70 overflow-hidden shadow-md">
                    <button type="button" @click="activeFaq = activeFaq === 1 ? null : 1"
                            class="w-full p-4.5 sm:p-5 text-start font-bold text-base sm:text-lg text-white flex items-center justify-between gap-4">
                        ...
                        <span class="inline-block transition-transform shrink-0" :class="activeFaq === 1 ? 'rotate-180' : ''">
                            <x-ui.icon name="chevron-down" class="size-5 text-blue-400" />
                        </span>
                    </button>
                    <div x-show="activeFaq === 1" x-cloak class="px-4.5 sm:px-5 pb-5 text-sm text-slate-300 leading-relaxed border-t border-slate-800/60 pt-3.5">
                ...
                <div class="rounded-2xl border border-slate-800 bg-slate-900/70 overflow-hidden shadow-md">
                    ...
                    <div x-show="activeFaq === 2" x-cloak class="px-4.5 sm:px-5 pb-5 text-sm text-slate-300 leading-relaxed border-t border-slate-800/60 pt-3.5">
                        AdminKit is crafted natively for <strong class="text-white">Laravel 13</strong> and <strong class="text-white">Livewire 4</strong>, leveraging <strong class="text-white">Tailwind CSS v4</strong> with automatic SPA wire-navigation.
                    </div>
                </div>
                ...
                <div class="rounded-2xl border border-slate-800 bg-slate-900/70 overflow-hidden shadow-md">
                    ...
                    <div x-show="activeFaq === 3" x-cloak class="px-4.5 sm:px-5 pb-5 text-sm text-slate-300 leading-relaxed border-t border-slate-800/60 pt-3.5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
                ...
                <div class="space-y-3.5">
                    ...
                    <ul class="space-y-2.5 text-sm text-slate-300 font-medium">
                        ...
                        <li><a href="#showcase" class="hover:text-blue-400 transition-colors">Demos</a></li>
                        <li><a href="{{ route('page', ['path' => 'docs']) }}" wire:navigate class="hover:text-blue-400 transition-colors">Documentation</a></li>
                        <li><a href="#quickstart" class="hover:text-blue-400 transition-colors">Quickstart</a></li>

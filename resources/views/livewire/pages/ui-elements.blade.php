<div>
    ...
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
        {{-- Buttons --}}
        <x-ui.card id="buttons" class="scroll-mt-24" title="Buttons" subtitle="Variants, sizes & states">
        ...
        {{-- Badges --}}
        <x-ui.card id="badges" class="scroll-mt-24" title="Badges" subtitle="Status & labels">
            <div class="flex flex-wrap gap-2">
        ...
        {{-- Alerts --}}
        <x-ui.card id="alerts" class="scroll-mt-24" title="Alerts" subtitle="Contextual feedback">
            <div class="space-y-3">
        ...
        {{-- Form inputs --}}
        <x-ui.card id="inputs" class="scroll-mt-24" title="Inputs" subtitle="Text fields, selects & more">
            <div class="space-y-4">
        ...
        {{-- Avatars --}}
        <x-ui.card id="images" class="scroll-mt-24" title="Avatars" subtitle="Users, groups & status">
        ...
        <x-ui.card id="overlays" class="scroll-mt-24" title="Overlays" subtitle="Dropdown, modal & toast">
            <div class="flex flex-wrap gap-2">
        ...
        {{-- Progress --}}
        <x-ui.card id="progress" class="scroll-mt-24" title="Progress & Toggles" subtitle="Bars, spinners & switches">
            <div class="space-y-4">

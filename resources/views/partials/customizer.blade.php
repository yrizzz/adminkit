...
<div x-cloak>
    ...
    <aside :class="{
               'is-open': $store.ui.customizerOpen,
               'pointer-events-none': !$store.ui.customizerOpen,
               'rounded-s-[2.25rem] border-s border-t border-b border-border/80 sm:my-3 sm:me-3 sm:h-[calc(100vh-1.5rem)]': $store.ui.curvedLayout,
               'h-full rounded-none': !$store.ui.curvedLayout
           }"
           class="customizer-drawer fixed inset-y-0 z-[95] flex w-[24rem] max-w-[92vw] flex-col bg-card text-card-foreground shadow-2xl">

        <div class="flex items-center justify-between border-b border-border px-5 py-4"
             :class="$store.ui.curvedLayout ? 'rounded-ts-[2.25rem]' : ''">

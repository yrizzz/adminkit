        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'icon'  => 'lock',
                    'children' => [
                        ['label' => 'Sign In (Split)',          'route' => 'page', 'params' => ['path' => 'sign-in']],
                        ['label' => 'Sign In 2 (Centered)',     'route' => 'page', 'params' => ['path' => 'sign-in-2']],
                        ['label' => 'Sign Up (Split)',          'route' => 'page', 'params' => ['path' => 'sign-up']],
                        ...
                        ['label' => 'Reset Password',           'route' => 'page', 'params' => ['path' => 'reset-password']],
            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ...
                        ['label' => 'Cards',           'href' => '#'],
                        ['label' => 'Dropdowns',       'href' => '#'],
                        ['label' => 'Images & Figures','href' => '#'],
                        ['label' => 'List Group',      'href' => '#'],
                        ['label' => 'Navs & Tabs',     'href' => '#'],
                        ['label' => 'Object Fit',      'href' => '#'],

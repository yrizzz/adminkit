            ...
            'items' => [
                ...
                [
                    ...
                    'children' => [
                        ...
                        ['label' => 'Create Password',       'route' => 'password.request'],
                        ['label' => 'Lock Screen',           'href' => '#'],
                        ['label' => 'Reset Password',        'route' => 'password.request'],
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'icon'  => 'underline',
                    'children' => [
                        ['label' => 'Alerts',          'route' => 'ui.elements'],
                        ['label' => 'Badge',           'route' => 'ui.elements'],
                        ['label' => 'Breadcrumb',      'route' => 'ui.elements'],
                        ['label' => 'Buttons',         'route' => 'ui.elements'],
                        ['label' => 'Button Group',    'route' => 'ui.elements'],
                        ['label' => 'Cards',           'route' => 'ui.elements'],
                        ['label' => 'Dropdowns',       'route' => 'ui.elements'],
                        ['label' => 'Images & Figures','route' => 'ui.elements'],
                        ['label' => 'List Group',      'route' => 'ui.elements'],
                        ['label' => 'Navs & Tabs',     'route' => 'ui.elements'],
                        ['label' => 'Object Fit',      'route' => 'ui.elements'],
                        ['label' => 'Pagination',      'route' => 'ui.elements'],
                        ['label' => 'Popovers',        'route' => 'ui.elements'],
                        ['label' => 'Progress',        'route' => 'ui.elements'],
                        ['label' => 'Spinners',        'route' => 'ui.elements'],
                        ['label' => 'Toasts',          'route' => 'ui.elements'],
                        ['label' => 'Tooltips',        'route' => 'ui.elements'],
                        ['label' => 'Typography',      'route' => 'ui.elements'],
                    ],
                ],
                [
                    'label' => 'Nested Menu',
        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'route' => 'charts',
                    'children' => [
                        ['label' => 'Line',    'route' => 'charts'],
                        ['label' => 'Area',    'route' => 'charts'],
                        ['label' => 'Bar',     'route' => 'charts'],
                        ['label' => 'Pie',     'route' => 'charts'],
                        ['label' => 'Radar',   'route' => 'charts'],
                    ],
                ],
            ],
        ],
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'route' => 'forms',
                    'children' => [
                        ['label' => 'Elements',   'route' => 'forms'],
                        ['label' => 'Layouts',    'route' => 'forms'],
                        ['label' => 'Validation', 'route' => 'forms'],
                        ['label' => 'Wizard',     'route' => 'forms'],
                    ],
                ],
                [
                    'label' => 'Tables',
                    ...
                    'route' => 'tables',
                    'children' => [
                        ['label' => 'Basic Tables', 'route' => 'tables'],
                        ['label' => 'Data Table',   'route' => 'tables'],
                        ['label' => 'Editable',     'route' => 'tables'],
                    ],
                ],
            ],
        ],
